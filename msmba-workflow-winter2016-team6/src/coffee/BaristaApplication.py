...
class BaristaApplication(RoleApplication):
    ...
    def __init__(self):
        ...
        self.register_sink_step("MakeDrink", self.prepare_drink_form_creator, name_fields=["sequence", "CustomerName", "DrinkType","CoffeeorTea?"])
    ...
    def prepare_drink_form_creator(self, stepname, form):
        ...
        form.add_task_label(fields=["CustomerName","DrinkType","CoffeeorTea?"]) 
