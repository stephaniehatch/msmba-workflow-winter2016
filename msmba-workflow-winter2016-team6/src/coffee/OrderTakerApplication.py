...
class OrderTakerApplication(RoleApplication):
    ...
    def take_drink_order_form_creator(self, stepname, form):
        '''
        This method does the act ual work of building the user interface.
        '''
        # !!! improve this text...
        form.add_static_label('Please enter order details') 
        form.add_field(Type.SHORTSTRING, "CustomerName")
        form.add_field(Type.CHOICE, "CoffeeorTea?", choices=['Coffee', 'Tea'])  
        form.add_field(Type.SHORTSTRING, "DrinkType")
